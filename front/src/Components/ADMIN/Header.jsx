...
function Header({ OpenSidebar, onStatusChange }) {
  ...
  return (
    <header className="header">
      ...
      {isRequestedRoute && (<h2 style={{color:'white',fontFamily:'Core-Heavy'}}>Requested Certificate</h2>)}
      {iseUploadedRoute && (<h2 style={{color:'white',fontFamily:'Core-Heavy'}}>Uploaded Certificate</h2>)}
      {isHeaderRoute && (<h2 style={{color:'white',fontFamily:'Core-Heavy'}}>Dashboard</h2>)}
