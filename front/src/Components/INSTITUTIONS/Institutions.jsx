...
function Institutions() {
  ...
  return (
    <>
    <section style={{backgroundSize:`${(window.outerHeight - scrollPosition) / 3}%`}} className='banner'>
    ...
    <div className="institutions-container">
        ...
        <div className="search-institutions-container">
        <AiOutlineSearch />
        <input type="text" placeholder='Search Institutions Name' />
        </div>
